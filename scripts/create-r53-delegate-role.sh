...
DelegationRoleStackName="r53_${HostedZoneName}_${AwsAccountId}"
DelegationRoleStackName=${DelegationRoleStackName//./-}
DelegationRoleStackName=${DelegationRoleStackName//_/-}
cdk deploy $DelegationRoleStackName --require-approval never --progress events || exit 1
